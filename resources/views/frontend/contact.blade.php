...
<input type="text" name="name" value="{{ old('name') }}" placeholder="Name" class="form-control">
       ...
       <span class="text-danger">@error('description') {{ $message }} @enderror</span>
        ...
        <br>
            ...
            <button type="submit" class="bbg form-control">Submit</button>
            <br>
            
            <p class="text-center">
                    <a style="text-decoration:none; color:#000000;" href="{{ URL('terms-and-condition') }}">
                <b>Terms and Condition</b></a> and <a  style="text-decoration:none; color:#000000;" href="{{ URL('privacy-policy') }}"><b>Privacy Policy</b></a>
            </p> 
