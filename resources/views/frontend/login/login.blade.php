...
<body>
    ...
    <img src="{{ asset('public/frontend/images/mainLOGO.png') }}" height="150px" width="503px" class="img-fluid" alt="MapBirdy">
        ...
        <h6 class="text-black">Sign In</h6>
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3 form-check">
                ...
                <a class="forget-password text-black " style="float:right;"  href="forgotPassword" >Forgot Password?</a>
            </div>
            <button type="submit" class="bbg form-control">Sign In</button>
            <br><br>
            <div class="text-center text-black mb-4"> OR </div>
            <div class="butt">
        ...
        <p class="text-center mt-3 text-black">Don't have an account? <a class="text-black aa" href="{{ url('/registration') }}"><b>Sign Up</b></a></p>
