...
<div class="container">
  ...
  <img style="margin-top:100px"src="{{ asset('public/frontend/images/mainLOGO.png') }}" height="150px" width="503px" class="img-fluid" alt="MapBirdy">
</a>
...
<input type="text"  name="name" value="@if(old('name') !=''){{ old('name') }}@else{{ $name }}@endif" placeholder="Name" class="form-control">
        ...
        <label for="" style="font-weight: bolder;"> Change Password</label>
          <input class="form-control" id="password" type="password" name="password" placeholder="Enter New Password" value="" autocomplete="off">
