...
<head>
  ...
  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-GHX0XEFJQ3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-GHX0XEFJQ3');
</script>
</head>
...
@if($questions->opt1 !="")
 <input type="radio" value="1" class="btn-check" name="options" id="option_{{ $questions->q_id }}_1" autocomplete="off"  />
  ...
  ?>
  <label class="btn btn-secondary {{$btn_val1}} options" for="option1" id="{{ $questions->q_id }}_1" ids="{{ $questions->q_id }}_1">{{ $questions->opt1 }}</label>
...
@if($questions->opt2 !="")
      ...
      ?>
      <label class="btn btn-secondary {{$btn_val2}}  options" for="option1" id="{{ $questions->q_id }}_2" ids="{{ $questions->q_id }}_2">{{ $questions->opt2 }}</label>
      <div class=" p_voutes"> <span>1</span> Votes <span>(1%)</span></div>
  @endif
</div>
<div class="col-3 text-center">
@if($questions->opt3 !="")
  ...
  <?php
      ...
      ?>
  <label class="btn btn-secondary {{$btn_val3}} options" for="option1" id="{{ $questions->q_id }}_3" ids="{{ $questions->q_id }}_3">{{ $questions->opt3 }}</label>
      <div class=" p_voutes"> <span>1</span> Votes <span>(1%)</span></div>
  @endif
</div>
<div class="col-3 text-center">
@if($questions->opt4 !="")
 ...
 <?php
      ...
      ?>
 <label class="btn btn-secondary {{$btn_val4}} options" for="option4" id="{{ $questions->q_id }}_4" ids="{{ $questions->q_id }}_4">{{ $questions->opt4 }}</label>
      <div class=" p_voutes"> <span>1</span> Votes <span>(1%)</span></div>
  @endif
</div>
    </div>
